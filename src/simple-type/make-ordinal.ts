...
function replaceWithOrdinalVariant(_: unknown, numberWord: keyof typeof ordinalLessThanThirteen): string {
  return ordinalLessThanThirteen[numberWord] as string
}
